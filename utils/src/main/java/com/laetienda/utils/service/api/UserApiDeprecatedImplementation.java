...
public class UserApiDeprecatedImplementation extends ApiClientImplementation implements UserApiDeprecated {
    final private static Logger log = LoggerFactory.getLogger(UserApiDeprecatedImplementation.class);
...
//    private String port;
    ...
    public UserApiDeprecatedImplementation() {
...
//    public UserApiDeprecated setSessionId(String sessionId){
