...
//        }
//
//        if(friends.stream().anyMatch(f -> f.getBuddy().getUserId().equals(member.getUserId()))){
...
//        }else{
//            Friend friend = new Friend(member, CompanyFriendStatus.REQUESTED);
//            friends.add(friend);
//        }
//        return this;
//    }
...
//                .anyMatch(f -> f.getBuddy().getUserId().equals(member.getUserId()))
//        ){
//            List<Friend> temp = friends.stream().filter(f -> f.getBuddy().getUserId().equals(member.getUserId())).toList();
//
//            if(temp.size() > 1){
...
//                this.friends.stream()
//                        .filter(f -> f.getBuddy().getUserId().equals(member.getUserId()))
...
//
//        if(temp.size() == 1){
//            friends.removeIf(f -> f.getBuddy().getUserId().equals(member.getUserId()));
//        }
//
//        return this;
//    }
