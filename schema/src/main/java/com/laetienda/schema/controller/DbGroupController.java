...
public class DbGroupController {
    ...
    @GetMapping("${api.schema.group.file.findAll}") //groups
    public ResponseEntity<List<DbGroup>> findAll() throws HttpStatusCodeException {
        log.info("DbGroupController::findAll");
